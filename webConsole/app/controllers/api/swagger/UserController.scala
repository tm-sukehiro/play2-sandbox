...
import com.github.sample.dto.{MessageDTO, UserDTO, UserWithTimeStampDTO}
...
class UserController @Inject() () extends Controller {
  ...
  def getAll() = Action {
    val users = Array(UserDTO(1, "testUser"), UserDTO(2, "testUser2"))
